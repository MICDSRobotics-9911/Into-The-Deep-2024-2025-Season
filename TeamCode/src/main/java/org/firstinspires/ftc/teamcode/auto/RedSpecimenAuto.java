...
import org.firstinspires.ftc.teamcode.common.commandbased.ManualSlideCommand;
...
public class RedSpecimenAuto extends LinearOpMode {
    ...
    public static Pose firstPose = new Pose(15, -31, 0);
    ...
    public void runOpMode() throws InterruptedException {
        ...
        CommandScheduler.getInstance().schedule(
                new SequentialCommandGroup(
                        ...
                        new ManualSlideCommand(1900),
                        new PositionCommand(secondInBetweenPose, 0.5),
                        new WaitCommand(1000),
                        new ManualSlideCommand(1400),
                        new WaitCommand(300),
